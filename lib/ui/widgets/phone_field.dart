...
import 'package:gores/data/countries.dart';
...
class PhoneField extends StatefulWidget {
  ...
  final TextStyle? dialogCountriesStyle;

  PhoneField({
    this.initialCountryCode,
    this.maxLength,
    this.dialogDecoration,
    this.dialogCountriesStyle,
                          ...
                          children: <Widget>[
                            ListTile(
                              ...
                              title: Text(
                                ...
                                style: widget.dialogCountriesStyle,
                              ),
                              trailing: Text(
